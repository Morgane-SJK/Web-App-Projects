...
function saveImage(){
	...
	document.getElementById("saveimage").innerHTML="<p>The image you want to save:</p> <img src= '"+dataURL+"' border='2px' solid black width='80%'>";
}

/*OLD Function : open in a new tab but not possible to download the image 
function testSaveImage(){
	var dataURL = canvas.toDataURL('image/png');
	window.open(dataURL,'','scrollbars=no,menubar=no,height=600,width=800,resizable=yes,toolbar=no,status=no')
	//return dataURL;
}*/
